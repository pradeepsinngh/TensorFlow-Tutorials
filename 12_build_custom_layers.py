...
class CustomLayer1(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.weight = self.add_weight(name='W',
                                        shape=shape,
                                        initializer=tf.initializer.RandomNormal,
                                        trainable=True)
...
# Custom Layer2 : extending TF 'Layer' class.
...
class CustomLayer2(layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.inner_layer2 = layers.Dense(self.nums_units)
